...
public final class SelfTalkClothConfig {
    ...
    public static void onAddClothConfig(AddClothConfigEvent event) {
        ...
        eventContext.add(entryBuilder.startBooleanToggle(
                ...
                .build());
        eventContext.add(entryBuilder.startDoubleField(
                        Component.translatable("config.maid_self_talk.event_context.range"),
                ...
                .build());
        eventContext.add(entryBuilder.startIntSlider(
                        Component.translatable("config.maid_self_talk.event_context.max_buffered"),
                ...
                .build());
        eventContext.add(entryBuilder.startBooleanToggle(
                        Component.translatable("config.maid_self_talk.event_context.hurt_enabled"),
